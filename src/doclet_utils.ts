...
export function hasParamsDoclet(doclet: TDoclet): boolean
{
...
export function isConstructorDoclet(doclet: TDoclet): boolean
{
    return !!(
        doclet.kind === 'class'
        && doclet.meta
...
export function isEnumDoclet(doclet: TDoclet): boolean
{
