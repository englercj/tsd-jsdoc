...
/**
 * @warning This interface is just a hack, not really a doclet as generated by jsdoc.
 * Jsdoc generates member IMemberDoclet objects.
 * We fake them into IExportDefaultDoclet objects, in order to facilitate the code in the Emitter._parseTreeNode() member function.
 */
interface IExportDefaultDoclet extends IDocletBase {
    kind: 'export default';
}
...
/**
 * @warning IExportDefaultDoclet temporarily added to this type.
 */
